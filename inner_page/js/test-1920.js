			...
			series : [
				{
					...
					data:[
						...
						{value:111, name:'银行'},
						{value:111, name:'火电'},
						{value:111, name:'电子零部件'},
						{value:111, name:'PC,服务器及硬件'},
						{value:111, name:'医药行业'},
						{value:111, name:'其他'}
					],
					itemStyle: {
...
function init_myChart6(){
	var data = {"uploadData":[{"count":5421,"areaName":"bbb"},{"count":6512,"areaName":"bbb"},{"count":3721,"areaName":"bbb"},{"count":2842,"areaName":"bbb"}
							,{"count":6427,"areaName":"bbb"},{"count":4422,"areaName":"bbb"},{"count":1020,"areaName":"bbb"},{"count":1421,"areaName":"bbb"},{"count":1776,"areaName":"bbb"}
							,{"count":2428,"areaName":"bbb"}]};
	var uploadCnt = [];
	var updateCnt = [];
	//var collectionCnt = [];
	//var dailyCnt = [];
...
var xData = ['cccc','cccc','cccc','cccc','cccc','cccc', 'cccc', 'cccc', 'cccc','cccc'];
